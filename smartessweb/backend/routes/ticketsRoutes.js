...
const { getTickets, deleteTicket, fetchIndividualTicket, getAssignableEmployees, getAssignedUsers, assignUsersToTicket, unassignUserFromTicket, closeTicket } = require('../controllers/ticketsController');
