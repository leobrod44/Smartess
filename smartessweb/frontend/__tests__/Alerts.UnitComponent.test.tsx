...
const mockAlerts: Alert[] = [
    { id: '1', projectId: 'p1', unitNumber: '101', message: 'Smoke Alarm Activated', timestamp: new Date(), resolved: false, icon: 'icon1' },
    { id: '2', projectId: 'p2', unitNumber: '102', message: 'Water Leak Detected', timestamp: new Date(), resolved: false, icon: 'icon2' },
    { id: '3', projectId: 'p3', unitNumber: '103', message: 'Thermostat > 25°C', timestamp: new Date(), resolved: false, icon: 'icon3' },
  ];
