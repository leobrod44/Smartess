...
const AlertPage = () => {
  ...
  return (
    <div className=" mx-4 lg:mx-8 min-h-screen flex-col">
      ...
      <h2 className="text-left text-[#325a67] text-[16px] leading-2 tracking-tight pb-10">View and manage the alerts generated by the hubs across your organization. Use the Project Filter on the left, or the search bar and filter above to narrow results. </h2>
