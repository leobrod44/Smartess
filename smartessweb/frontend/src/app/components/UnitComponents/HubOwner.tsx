const HubOwner = ({ owner }: { owner: { name: string; email: string } }) => (
    ...
    <button className="w-[78px] h-[23px] px-0.5 bg-[#4b7d8d] rounded-[10px] justify-center items-center gap-5 inline-flex hover:bg-[#1f505e] transition duration-300
    text-center text-white text-xs font-['Sequel Sans'] leading-tight tracking-tight">
        Contact
    </button>
  </div>
);
