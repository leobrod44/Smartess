...
function UserInfoModal({
  ...
  return (
    <Modal open={open} onClose={onClose} aria-labelledby="user-details-modal">
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-4/5 max-w-md bg-white border border-gray-300 rounded-lg shadow-lg p-6 overflow-y-auto max-h-[80vh] flex flex-col items-center justify-center">
        {/* Close Button */}
        <IconButton
          onClick={onClose}
