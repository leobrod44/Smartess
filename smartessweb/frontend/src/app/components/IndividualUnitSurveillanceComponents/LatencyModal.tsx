...
const LatencyModal: React.FC<LatencyModalProps> = ({ data, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-opacity-50 backdrop-blur-sm z-50">
      <div className="relative w-[90%] max-w-[1000px] h-[90%] max-h-[625px] bg-white rounded-lg p-10 overflow-y-auto shadow-lg">
        ...
        <h2 className="text-xl font-bold text-[#30525E] mb-4">Latency Over Time</h2>
        ...
        <div className="border border-black rounded-lg w-full h-[420px] flex justify-center">
          ...
          >
            ...
            <YAxis 
              ...
              label={{ value: 'Milliseconds', angle: -90, position: 'insideLeft', offset: -15 }}
            />
            <Tooltip 
              contentStyle={{
                color: "#333"
