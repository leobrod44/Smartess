...
const NoResultsFound= ({ searchItem }: NoResults) => {
    ...
    return(
        ...
        <div className="w-full flex flex-col items-center justify-center gap-2">
            <Image src={noresultsimg} alt="No results found" width={240} height={200} className="" />
           <h2 className=" text-2xl text-[#325a67]"> We're Sorry...</h2>
           <h3> We couldnt find any matches for <span className="text-[#325a67]">"{searchItem}"</span></h3>
