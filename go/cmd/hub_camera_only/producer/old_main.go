...
//	//	"pipe:1")
//	// Optimized FFMPEG command for better streaming performance
//	cmd := exec.Command("ffmpeg",
//		"-i", RTSP_STREAM_URL,
//		"-c:v", "libx264",
...
//		"-bufsize", "4000k", // Encoding buffer
//		"-g", "30", // Keyframe interval
//		"-keyint_min", "30", // Minimum keyframe interval
//		"-sc_threshold", "0", // Disable scene change detection
//		"-f", "mp4",
//		"-movflags", "frag_keyframe+empty_moov+default_base_moof+faststart",
//		"-fragment_duration", "500000", // 500ms fragments
//		"pipe:1")
...
//	buf := make([]byte, 512*1024) // buffer to hold video data (512KB chunk)
//	for {
...
//		time.Sleep(40 * time.Millisecond) // Simulate real-time video chunk sending
//	}
